...
labels=c( 'Lapatinib', 'Vemurafenib', 'Sunitinib', 'Axitinib', 'Vismodegib', 'Sorafenib', 'Lenalidomide', 'Vandetanib', 'Imatinib' ), cex.axis=1 )

legend("bottomright",
       legend = c('HSA','ZIP','BLISS','LOEWE'),
       fill = c("lightblue", "lightgreen", "lightcoral", "gold"),    
       # title = "Synergy Metric",
