...
• Language : R
• Purpose : Propagate drug-target signals through an A549-specific network using Random Walk with Restart
• Main inputs : 
...
Step 3 : 3_GNMF.py
• Language : Python
• Purpose : Run graph-regularised NMF (λ = 0.9) to learn metagenes, select the optimal component count (elbow method)
• Main inputs : 
